  ...
  !function(e, t) {
    ...
    return function() {
      var __webpack_modules__ = {422: function(e, t, n) {
        ...
        var H = function(e2) {
          ...
          function n2(e3, r2) {
            ...
            return (0, o.Z)(this, n2), (i2 = t2.call(this)).subComponents = [], i2.compName = a2, i2.c = S(a2), i2.options = {}, i2.container = e3, i2.$container = j()(e3), i2.$container.addClass(["luna-".concat(a2), i2.c("platform-".concat(O()))]), i2.on("optionChange", function(e4, t3, n3) {
              var o2 = i2.c;
              e4 === "theme" && (i2.$container.rmClass(o2("theme-".concat(n3))).addClass(o2("theme-".concat(t3))), R()(i2.subComponents, function(e5) {
        ...
        var K = U("console");
        function X(e2) {
          var t2, n2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o2 = n2.topObj, r2 = n2.level, i2 = r2 === void 0 ? 0 : r2, a2 = n2.getterVal, s2 = a2 !== void 0 && a2, c2 = n2.unenumerable, l2 = c2 === void 0 || c2, u2 = "", d2 = "", f2 = [], h2 = [], v2 = "";
          o2 = o2 || e2;
          var g2 = {getterVal: s2, unenumerable: l2, level: i2 + 1}, y2 = i2 === 0, _2 = '<span class="'.concat(K("key"), '">'), x2 = '<span class="'.concat(K("number"), '">'), A2 = '<span class="'.concat(K("null"), '">'), C2 = '<span class="'.concat(K("string"), '">'), E2 = '<span class="'.concat(K("boolean"), '">'), O2 = '<span class="'.concat(K("special"), '">'), T2 = function(e3) {
          ...
          var Z2, I2 = d2 == "[object Array]", D2 = d2 == "[object Object]", B2 = d2 == "[object Number]", F2 = d2 == "[object RegExp]", L2 = d2 == "[object Symbol]", P2 = d2 == "[object Function]", H2 = d2 == "[object Boolean]";
          if (d2 == "[object String]")
            u2 = j2(ne(e2));
          else if (F2)
            ...
            te(e2) && (e2 = Object.getPrototypeOf(e2)), h2 = l2 ? Object.getOwnPropertyNames(e2) : Object.keys(e2), y2 ? (t2 = 1, u2 = "{", k()(h2, R2), u2 += f2.join(", ") + v2 + "}") : (u2 = z(e2)) === "Object" && (u2 = "{\u2026}");
          else if (B2)
            u2 = e2 + "", u2 = S()(u2, "Infinity") || u2 === "NaN" ? '"'.concat(u2, '"') : x2 + u2 + M2;
          else if (H2)
            ...
            try {
              te(e2) && (e2 = Object.getPrototypeOf(e2)), y2 ? (t2 = 1, u2 = "{", h2 = l2 ? Object.getOwnPropertyNames(e2) : Object.keys(e2), k()(h2, R2), u2 += f2.join(", ") + v2 + "}") : (u2 = z(e2)) === "Object" && (u2 = "{\u2026}");
            } catch (t3) {
              u2 = j2(e2);
            }
          return u2;
        ...
        var kt = /https?:\/\/([0-9.\-A-Za-z]+)(?::(\d+))?\/[A-Z.a-z0-9/]*\.js/g, Ct = {comment: "", string: "", number: "", keyword: "", operator: ""}, St = function(e2) {
          ...
          var t2 = At(n2);
          function n2(e3, o2) {
            var r2, i2 = o2.type, s2 = i2 === void 0 ? "log" : i2, c2 = o2.args, l2 = c2 === void 0 ? [] : c2, u2 = o2.id, d2 = o2.group, h2 = o2.targetGroup, p2 = o2.header, v2 = o2.ignoreFilter, m2 = v2 !== void 0 && v2, g2 = o2.accessGetter, b2 = o2.unenumerable, y2 = o2.lazyEvaluation;
          ...
          return (0, s.Z)(n2, [{key: "checkGroup", value: function() {
            ...
            var e3 = this.args, t3 = "";
            k()(e3, function(e4, n3) {
              n3 !== 0 && (t3 += " "), ue()(e4) ? t3 += Ke()(e4) : t3 += m()(e4);
            }), et()(t3);
            ...
            switch (t3 !== "group" && t3 !== "groupCollapsed" || e3.length === 0 && (e3 = ["console.group"]), t3) {
              ...
              case "warn":
                ...
                break;
              case "error":
                fe()(e3[0]) && e3.length !== 1 && (e3 = this.substituteStr(e3)), s2 = e3[0], a2 = "error", s2 = pe()(s2) ? s2 : new Error(this.formatCommon(e3)), c2 = this.formatErr(s2);
                break;
              case "table":
            ...
            var t3 = this.console.c, n3 = fe()(e3[0]) && e3.length !== 1;
            n3 && (e3 = this.substituteStr(e3));
            for (var o2 = 0, r2 = e3.length; o2 < r2; o2++) {
              var i2 = e3[o2];
              we()(i2) ? e3[o2] = this.formatEl(i2) : Ne()(i2) ? e3[o2] = this.formatFn(i2) : xt()(i2) ? e3[o2] = '<span class="'.concat(t3("regexp"), '">').concat(p()(m()(i2)), "</span>") : ue()(i2) ? e3[o2] = this.formatPreview(i2) : Oe()(i2) ? e3[o2] = '<span class="'.concat(t3("undefined"), '">undefined</span>') : Se()(i2) ? e3[o2] = '<span class="'.concat(t3("null"), '">null</span>') : $()(i2) ? e3[o2] = '<span class="'.concat(t3("number"), '">').concat(m()(i2), "</span>") : typeof i2 == "bigint" ? e3[o2] = '<span class="'.concat(t3("number"), '">').concat(m()(i2), "n</span>") : bt()(i2) ? e3[o2] = '<span class="'.concat(t3("boolean"), '">').concat(m()(i2), "</span>") : wt()(i2) ? e3[o2] = '<span class="'.concat(t3("symbol"), '">').concat(p()(m()(i2)), "</span>") : (i2 = m()(i2), o2 === 0 && n3 || (i2 = p()(i2)), i2.length > 5e3 && (i2 = N()(i2, 5e3, {separator: " ", ellipsis: "\u2026"})), e3[o2] = i2);
            }
            return e3.join(" ");
            ...
            return i2 === "Array" && e3.length > 1 ? (i2 = "(".concat(e3.length, ")"), r2 && (i2 = "Array".concat(i2))) : i2 === "RegExp" ? i2 = m()(e3) : we()(e3) && (i2 = this.formatElName(e3)), '<div class="'.concat(n3("preview"), '" data-id="').concat(o2, '">') + '<div class="'.concat(n3("preview-container"), '">') + '<div class="'.concat(n3("preview-icon-container"), '"><span class="').concat(n3("icon icon-caret-right"), '"></span></div>') + '<span class="'.concat(n3("preview-content-container"), '">') + '<span class="'.concat(n3("descriptor"), '">').concat(p()(i2), "</span> ") + '<span class="'.concat(n3("object-preview"), '">').concat(r2 ? "" : X(e3, {getterVal: this.accessGetter, unenumerable: false}), "</span>") + "</span></div>" + '<div class="'.concat(n3("json hidden"), '"></div></div>');
        ...
        var Jt, Qt = function(e2) {
          ...
          var t2 = qt(n2);
          function n2(e3, o2) {
            var r2, i2, s2 = o2.compName, c2 = (arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}).theme, l2 = c2 === void 0 ? "light" : c2;
            return (0, a.Z)(this, n2), (r2 = t2.call(this)).subComponents = [], r2.compName = s2, r2.c = U(s2), r2.options = {}, r2.container = e3, r2.$container = Ge()(e3), r2.$container.addClass(["luna-".concat(s2), r2.c("platform-".concat((i2 = J()(), i2 === "os x" ? "mac" : i2)))]), r2.on("optionChange", function(e4, t3, n3) {
              var o3 = r2.c;
        ...
        var Kt = navigator.userAgent, Xt = Kt.indexOf("Android") > -1 || Kt.indexOf("Adr") > -1, en = 0, tn = function(e2) {
          ...
          return (0, s.Z)(n2, [{key: "setGlobal", value: function(e3, t3) {
            ...
            if ((o2 = fe()(e3) ? {type: e3, args: t3, header: n3} : e3).type === "groupEnd")
              return this.lastLog.groupEnd(), void this.groupStack.pop();
            if (a2.size > 0 && (o2.group = a2.peek()), zt()(o2, {id: ++en, accessGetter: l2, unenumerable: u2, lazyEvaluation: d2}), o2.type === "group" || o2.type === "groupCollapsed") {
            ...
            var p2 = this.lastLog;
            if (p2 && !b()(["html", "group", "groupCollapsed"], h2.type) && p2.type === h2.type && h2.isSimple() && p2.text() === h2.text() ? (p2.addCount(), h2.header && p2.updateTime(h2.header.time), h2 = p2, this.detachLog(p2)) : (i2.push(h2), this.lastLog = h2), c2 !== 0 && i2.length > c2) {
              var v2 = i2[0];
            ...
            var t3;
            (this.selectedLog && (this.selectedLog.deselect(), this.selectedLog = null), Se()(e3)) ? this.emit("deselect") : (this.selectedLog = e3, (t3 = this.selectedLog) === null || t3 === void 0 || t3.select(), this.emit("select", e3));
          }}, {key: "bindEvent", value: function() {
            ...
            if (!W()(a2)) {
              for (var c2 = a2.scrollTop, l2 = a2.offsetHeight, u2 = s2.getBoundingClientRect().width, d2 = c2 - n3, f2 = c2 + l2 + r2, h2 = this.displayLogs, p2 = 0, v2 = 0, m2 = 0, g2 = h2.length, b2 = this.fakeEl, y2 = document.createDocumentFragment(), w2 = [], _2 = 0; _2 < g2; _2++) {
                ...
                x2.height !== 0 && A2 === u2 || (y2.appendChild(x2.container), w2.push(x2));
              }
              if (w2.length > 0) {
                b2.appendChild(y2);
        ...
        var K, X = function(e2) {
          ...
          var t2 = V(n2);
          function n2(e3, o2) {
            var i2, a2, s2 = o2.compName, c2 = (arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}).theme, l2 = c2 === void 0 ? "light" : c2;
            return (0, r.Z)(this, n2), (i2 = t2.call(this)).subComponents = [], i2.compName = s2, i2.c = M(s2), i2.options = {}, i2.container = e3, i2.$container = f()(e3), i2.$container.addClass(["luna-".concat(s2), i2.c("platform-".concat((a2 = N()(), a2 === "os x" ? "mac" : a2)))]), i2.on("optionChange", function(e4, t3, n3) {
              var o3 = i2.c;
              e4 === "theme" && (i2.$container.rmClass(o3("theme-".concat(n3))).addClass(o3("theme-".concat(t3))), H()(i2.subComponents, function(e5) {
                return e5.setOption("theme", t3);
              }));
        ...
        var L, P = function(e2) {
          ...
          var t2 = F(n2);
          function n2(e3, o2) {
            var r2, a2 = o2.compName, s2 = (arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}).theme, c2 = s2 === void 0 ? "light" : s2;
            return (0, i.Z)(this, n2), (r2 = t2.call(this)).subComponents = [], r2.compName = a2, r2.c = E(a2), r2.options = {}, r2.container = e3, r2.$container = p()(e3), r2.$container.addClass(["luna-".concat(a2), r2.c("platform-".concat(N()))]), r2.on("optionChange", function(e4, t3, n3) {
              var o3 = r2.c;
              e4 === "theme" && (r2.$container.rmClass(o3("theme-".concat(n3))).addClass(o3("theme-".concat(t3))), j()(r2.subComponents, function(e5) {
                return e5.setOption("theme", t3);
              }));
        ...
        var $, G = function(e2) {
          ...
          var t2 = H(n2);
          function n2(e3, o2) {
            var r2, i2, a2 = o2.compName, c2 = (arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}).theme, l2 = c2 === void 0 ? "light" : c2;
            return (0, s.Z)(this, n2), (r2 = t2.call(this)).subComponents = [], r2.compName = a2, r2.c = N(a2), r2.options = {}, r2.container = e3, r2.$container = g()(e3), r2.$container.addClass(["luna-".concat(a2), r2.c("platform-".concat((i2 = T()(), i2 === "os x" ? "mac" : i2)))]), r2.on("optionChange", function(e4, t3, n3) {
              var o3 = r2.c;
        ...
        var Ge = function(e2) {
          ...
          return (0, i.Z)(n2, [{key: "set", value: function(e3) {
            ...
            O()(l2, function(o2) {
              ...
              for (var s3 = 0, l3 = r3.length; s3 < l3; s3++) {
                ...
                if (b3 && !n3.options.accessGetter)
                  ...
                  try {
                    m3 = o2 === "virtual" ? v2[f2] : i2[f2], j()(m3) && m3.catch(K());
                  } catch (e4) {
            ...
            var i2 = arguments.length > 4 && arguments[4] !== void 0 && arguments[4], a2 = this.visitor, s2 = this.c, c2 = (0, o.Z)(n3), l2 = R()(n3, false);
        ...
        var L, P = function(e2) {
          ...
          function n2(e3, o2) {
            ...
            return (0, r.Z)(this, n2), (i2 = t2.call(this)).subComponents = [], i2.compName = a2, i2.c = E(a2), i2.options = {}, i2.container = e3, i2.$container = f()(e3), i2.$container.addClass(["luna-".concat(a2), i2.c("platform-".concat(N()))]), i2.on("optionChange", function(e4, t3, n3) {
              var o3 = i2.c;
              e4 === "theme" && (i2.$container.rmClass(o3("theme-".concat(n3))).addClass(o3("theme-".concat(t3))), j()(i2.subComponents, function(e5) {
                return e5.setOption("theme", t3);
              }));
            }), i2.setOption("theme", c2), i2;
          }
        ...
        var F = function(e2) {
          ...
          function n2(e3, r2) {
            ...
            return (0, o.Z)(this, n2), (i2 = t2.call(this)).subComponents = [], i2.compName = a2, i2.c = S(a2), i2.options = {}, i2.container = e3, i2.$container = h()(e3), i2.$container.addClass(["luna-".concat(a2), i2.c("platform-".concat(T()))]), i2.on("optionChange", function(e4, t3, n3) {
              var o2 = i2.c;
              e4 === "theme" && (i2.$container.rmClass(o2("theme-".concat(n3))).addClass(o2("theme-".concat(t3))), M()(i2.subComponents, function(e5) {
                return e5.setOption("theme", t3);
              }));
            }), i2.setOption("theme", c2), i2;
          }
        ...
        var ce = function(e2) {
          ...
          return (0, i.Z)(o2, [{key: "init", value: function(e3) {
            ...
            var r2 = o3.min, i2 = r2 === void 0 ? 0 : r2, a2 = o3.max, s2 = a2 === void 0 ? 1 : a2, c2 = o3.step, l2 = c2 === void 0 ? 0.1 : c2, u2 = this._genId(), d2 = this._setting.appendNumber(u2, e3.get(t3), n2, {max: s2, min: i2, step: l2, range: true});
        ...
        var gt = function(e2) {
          ...
          return (0, i.Z)(o2, [{key: "show", value: function() {
            ...
            var s2 = e3.name;
            return s2 ? (s2 = s2.toLowerCase(), this._tools[s2] ? ot.warn("Tool ".concat(s2, " already exists")) : (this._$tools.prepend('<div id="'.concat(Pe(s2), '" class="').concat(Pe(s2 + " tool"), '"></div>')), e3.init(this._$tools.find(".".concat(Pe(s2), ".").concat(Pe("tool"))), this), e3.active = false, this._tools[s2] = e3, s2 === "settings" ? t3.append({id: s2, title: s2}) : t3.insert(t3.length - 1, {id: s2, title: s2}), this)) : ot.error("You must specify a name for a tool");
          }}, {key: "remove", value: function(e3) {
            var t3 = this._tools;
            if (!t3[e3])
            ...
            o3.on("optionChange", function(e4, t4) {
              if (e4 === "level")
                n2.each(function() {
                  ...
                  e5[n3 === t4 || n3 === "all" && Y()(t4) ? "addClass" : "rmClass"](Pe("active"));
                });
        ...
        }(f()), Ut = 1e5, Vt = n(2439), Kt = n.n(Vt), Xt = n(9143), en = n.n(Xt), tn = n(2139), nn = n(8689), on2 = n(7935), rn = n(9119);
        function an(e2, t2) {
          var n2 = Object.keys(e2);
          if (Object.getOwnPropertySymbols) {
            var o2 = Object.getOwnPropertySymbols(e2);
        ...
        var cn = new (en())();
        cn.register("Network", tn), cn.register("Overlay", nn), cn.register("DOM", sn(sn({}, on2), {}, {getNodeId: on2.getDOMNodeId, getNode: on2.getDOMNode})), cn.register("Storage", rn);
          ...
          function o2() {
            ...
            return (0, r.Z)(this, o2), e3 = t2.call(this), (0, u.Z)((0, a.Z)(e3), "_reqWillBeSent", function(t3) {
              ...
              $t()(function(e4) {
                var t4 = mn()();
                t4 === "windows" && (t4 = "win");
                var n2 = [], o3 = bn()(["accept-encoding", "host", "method", "path", "scheme", "version"]), r2 = t4 === "win" ? function(e5) {
                  var t5 = /[\r\n]/.test(e5) ? '^"' : '"';
          ...
          return (0, i.Z)(e2, [{key: "show", value: function(e3) {
            ...
            e3.addEventListener = function(e4, n3, o2) {
              ...
              !function(e5, t4, n3) {
                ...
                D()(r2).length === 0 && delete e5.erudaEvents;
            ...
            if (s2 && D()(s2).length !== 0 && (t2.listeners = s2), oo(a2))
              return t2;
            ...
            if (!Be(e3.target) && e3.type === "attributes") {
        ...
        var Kn = function(e2) {
          return xe()(e2, function(e3) {
            ...
            return t2 = Pt()(t2), (n2 === "src" || n2 === "href") && !lt()(t2, "data") && (t2 = ro(t2)), n2 === "style" && (t2 = to(t2)), {name: n2, value: t2};
          });
        }, Xn = /rgba?\((.*?)\)/g, eo = /url\("?(.*?)"?\)/g;
        function to(e2) {
          ...
          return (0, i.Z)(e2, [{key: "destroy", value: function() {
            ...
            if (t2) {
              ...
              t2 = JSON.parse(JSON.stringify(t2)), C()(t2, function(t3, o2) {
                T()(t3) && (e3.config.get("hideErudaSetting") && (lt()(o2, "eruda") || o2 === "active-eruda") || n2.push({key: o2, val: Jt()(t3, 200)}));
              }), this._storeData = n2;
            }
          }}, {key: "_updateButtons", value: function() {
        ...
        var Bo = function(e2) {
          ...
          return (0, i.Z)(o2, [{key: "init", value: function(e3, t3) {
            ...
            t3 && t3.getEntries ? this._performance.getEntries().forEach(function(t4) {
              if (t4.initiatorType === "img" || Lo(t4.name)) {
            ...
            function r2(e4) {
              return function(t4) {
                if (n2.get("sources")) {
                  ...
                  e4 !== "iframe" && ko()(location.href, r3) ? So()({url: r3, success: function(t5) {
                    o3(e4, t5);
        ...
        t.performSearch = function(e2) {
          ...
          T(document, function(e3) {
            ...
            if (o3 === 1) {
              ...
              o3 === 3 && b.default(y.default(e3.nodeValue), t2) && n2.push(e3);
          });
          var o2 = C.createId();
        ...
        function E(e2) {
          ...
          n2 && (t2 = l.getNode(n2)), r2 && (t2 = _.getObj(r2)), t2.nodeType !== 1 && t2.nodeType !== 3 || (p.default(o2, {contentColor: "transparent", paddingColor: "transparent", borderColor: "transparent", marginColor: "transparent"}), k || v.default(o2, {showInfo: false}), s.highlight(t2, o2));
        }
        function O() {
          s.hide();
        }
        ...
        var r = o(n(3367)), i = o(n(6156)), a = o(n(6472)), s = o(n(4777)), c = o(n(9833)), l = o(n(2749)), u = o(n(3708)), d = o(n(7470)), f = o(n(1754)), h = o(n(3085)), p = o(n(2533)), v = o(n(300)), m = o(n(1116)), g = o(n(8740)), b = o(n(415)), y = o(n(9804)), w = o(n(6257)), _ = new Map(), x = new Map(), A = new Map(), k = new Map(), C = 1;
        function S(e2, t2) {
          var n2 = x.get(e2);
        ...
        t = function(e2) {
          var n2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o2 = n2.self, l2 = n2.startTime, u2 = l2 === void 0 ? m() : l2, p2 = n2.timeout, y2 = p2 === void 0 ? 0 : p2, w2 = n2.depth, _2 = w2 === void 0 ? 0 : w2, x2 = n2.curDepth, A2 = x2 === void 0 ? 1 : x2, k2 = n2.visitor, C2 = k2 === void 0 ? new M() : k2, S2 = n2.unenumerable, O2 = S2 !== void 0 && S2, N2 = n2.symbol, j2 = N2 !== void 0 && N2, z2 = n2.accessGetter, R = z2 !== void 0 && z2, Z = n2.ignore, I = Z === void 0 ? [] : Z, D = "", B = {visitor: C2, unenumerable: O2, symbol: j2, accessGetter: R, depth: _2, curDepth: A2 + 1, timeout: y2, startTime: u2, ignore: I}, F = r(e2, false);
          if (F === "String")
            D = T(e2);
          else if (F === "Number")
            ...
            D = "{";
            var P, H = [], $ = C2.get(e2);
            if ($ ? (P = $.id, H.push('"reference":'.concat(P))) : (P = C2.set(e2), H.push('"id":'.concat(P))), H.push('"type":"'.concat(F, '"')), a(F, "Function") ? H.push('"value":'.concat(T(s(e2)))) : F === "RegExp" && H.push('"value":'.concat(T(e2))), !$) {
              var G = c(e2);
          ...
          function b2(e3, n3, o3) {
            ...
            return l(["get", "set"], function(i2) {
              if (x(o3, i2 + " ")) {
                ...
                e3[a3] && ((n3 = j(n3, t2)) === "Timeout" && (n3 = z), A(g2, [a3, i2], n3), r3 = true);
              }
            }), r3;
          }
        }
          ...
          return r(t2, e2), t2.prototype.setContainer = function(e3) {
            ...
            return e3.showRulers && this.drawAxis(this.context, r2, i2), e3.paths.length && (e3.showExtensionLines && function(e4, t4, n3, o3, r3, i3, a2, s2) {
              ...
              var u2 = (0, c.createChild)(e4, "div"), d2 = (0, c.createChild)(u2, "div", "tooltip-content"), f2 = function(e5, t5) {
                ...
                var _2 = v2.padding;
                _2 && _2 !== "0px" && O2("Padding", _2);
                var x2 = e5.contrast ? e5.contrast.backgroundColor : null, A2 = m2 && m2 !== "#00000000" && x2 && x2 !== "#00000000";
        ...
        var h = function(e2) {
          ...
          function i2(e3, t3) {
            ...
            for (var Z = 0; Z < t3.length; ++Z) {
              var I = t3[Z];
              switch ((A = I[0]) !== "S" && A !== "s" && A !== "C" && A !== "c" && (C = null, S = null), A !== "T" && A !== "t" && A !== "Q" && A !== "q" && (E = null, O = null), A) {
                case "m":
                case "M":
                  A === "m" ? (p2 += I[1], m2 += I[2]) : (p2 = I[1], m2 = I[2]), A !== "M" && z || (z = {x: p2, y: m2}), e3.moveTo(p2, m2);
                  break;
                case "l":
                ...
                case "c":
                  ...
                  break;
                case "S":
                  C !== null && S !== null || (C = p2, S = m2), e3.bezierCurveTo(2 * p2 - C, 2 * m2 - S, I[1], I[2], I[3], I[4]), C = I[1], S = I[2], p2 = I[3], m2 = I[4];
                  break;
                case "s":
                  C !== null && S !== null || (C = p2, S = m2), e3.bezierCurveTo(2 * p2 - C, 2 * m2 - S, I[1] + p2, I[2] + m2, I[3] + p2, I[4] + m2), C = I[1] + p2, S = I[2] + m2, p2 += I[3], m2 += I[4];
                  break;
                case "Q":
                ...
                case "q":
                  ...
                  break;
                case "T":
                  E !== null && O !== null || (E = p2, O = m2), E = 2 * p2 - E, O = 2 * m2 - O, p2 = I[1], m2 = I[2], e3.quadraticCurveTo(E, O, p2, m2);
                  break;
                case "t":
                  E !== null && O !== null || (E = p2, O = m2), E = 2 * p2 - E, O = 2 * m2 - O, p2 += I[1], m2 += I[2], e3.quadraticCurveTo(E, O, p2, m2);
                  break;
